...
const N_MELS: usize = 128; // <--- Crucial: Use 128 for large-v3
...
impl WhisperProcessor {
  pub fn new() -> Result<Self> {
    ...
    // The shape is [128, 201]. N_FFT/2 + 1 = 201.
    let mel_filters = Array2::from_shape_vec((N_MELS, N_FFT / 2 + 1), mel_filters_vec).map_err(|e| anyhow!("Failed to create mel filters array: {}", e))?;
