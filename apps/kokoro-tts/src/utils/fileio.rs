// https://github.com/lucasjinreal/Kokoros/blob/4c18036a174d28ddec3181c99395af332c32b28d/kokoros/src/utils/fileio.rs
...
pub async fn download_file_from_url(
  ...
  if resp.status().is_success() {
    ...
    eprintln!("Downloading {path} - total size: {total_size}");
