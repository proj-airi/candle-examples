// https://github.com/lucasjinreal/Kokoros/blob/4c18036a174d28ddec3181c99395af332c32b28d/kokoros/src/tts/phonemizer.rs

use lazy_static::lazy_static;
use regex::Regex;

use crate::kokoro::{normalize, vocab::VOCAB};
...
impl EspeakBackend {
  fn new(
    ...
    EspeakBackend { language: language.to_string(), preserve_punctuation, with_stress }
  }
...
impl Phonemizer {
  pub fn new(lang: &str) -> Self {
    ...
    Phonemizer { lang: lang.to_string(), backend }
  }
